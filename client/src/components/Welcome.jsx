...
import Loaxder from './Loaxder'
import { TransactionContext } from '../context/TransactionContext'
import { shortenAddress } from '../utils/addresshort'
...
const Welcome = () => {
    ...
    return (
        ...
        <div className='flex flex-1 justify-start md:mr-10 '>
            <span>
            
        <h1 className='text-3xl w-full sm:text-5xl text-white text-gradient py-1'>Send Crypto<br/> across the world</h1>
        ...
        <div className='flex flex-col flex-1 items-center justify-start w-full md:mt-0 mt-10'>
            ...
            <div className='p-5 sm:w-96 w-full flex flex-col justify-start items-center blue-glassmorphism '>
                ...
                {isLoading ?(
                    ...
                    className='text-white w-full mt-2 p-2 border-[1px] border-[#3d4f77c] rounded-full cursor-pointer'
                    >Send Now</button>
                )}
            </div>
        </div>
